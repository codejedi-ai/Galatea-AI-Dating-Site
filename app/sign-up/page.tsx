        ...
        <div className="w-full max-w-md">
          {!showLoadingScreen && (
            <div className="text-center mb-8">
              ...
              <h1 className="text-3xl font-bold">
                Join <span className="g-text-accent">Galatea.AI</span>
              </h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              <Label htmlFor="name" className="g-text-primary">Full Name</Label>
              <Input
                id="name"
                type="text"
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs g-text-muted mt-1">
                Password must be at least 6 characters long
              </p>
            </div>

            <div className="space-y-2">
              <Label htmlFor="confirmPassword" className="g-text-primary">Confirm Password</Label>
              <div className="relative">
                <Input
                  id="confirmPassword"
            ...
            <div className="flex items-start space-x-2">
              ...
              <Label htmlFor="terms" className="text-sm g-text-muted">
                I agree to the{" "}
                <Link href="/terms" className="g-text-accent hover:underline">Terms of Service</Link>
                {" "}and{" "}
                <Link href="/privacy" className="g-text-accent hover:underline">Privacy Policy</Link>
              </Label>
            </div>
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 g-bg-page g-text-muted">Or sign up with</span>
              </div>
            </div>
            ...
            <div className="text-center mt-6">
              <p className="g-text-muted">
                ...
                <Link href="/sign-in" className="g-text-accent hover:underline">Sign in</Link>
              </p>
            </div>
          </form>
        </div>
